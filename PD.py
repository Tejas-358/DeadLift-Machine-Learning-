...
counterBox = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="black", fg_color="blue")
counterBox.place(x=160, y=41)
counterBox.configure(text='0')
probBox = ck.CTkLabel(window, height=40, width=120, text_font=("Arial", 20), text_color="black", fg_color="blue")
...
button = ck.CTkButton(window, text="RESET", command = reset_counter, height=40, width=120, text_font=("Arial", 20), text_color="black", fg_color="blue")
...
with open('D:\Programs\AI\Pose Detection\deadlift.pkl', 'rb') as f:
    model = pickle.load(f)
